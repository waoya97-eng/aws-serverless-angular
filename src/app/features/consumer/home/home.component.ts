...
@Component({
  ...
  template: `
    ...
    <section class="section todo">
      ...
      <ul>
        <li>商品詳細ページ（ProductDetailComponent）を作成する</li>
        <li>カート機能（CartComponent）を実装する</li>
        <li>注文機能（OrdersComponent）を実装する</li>
        <li>出品者向け商品管理（SellerProductsComponent）を実装する</li>
